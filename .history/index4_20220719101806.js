...
function draw() {
	...
	for (let i = 0; i < particleCount; i++) {
		...
		// Taken from the particle example from p5 references, a clever way of passing an array of particles to our function so we can track the distance between current particle and other particles.
		particles[i].joinParticles(particles.slice(i))
	}

	push()
	// Using our fft we're going to call the waveform() function to get our waveform data.
